<%@ Page Language="VB" AutoEventWireup="false" CodeFile="coy_uploads.aspx.vb" Inherits="coy_uploads" %>
        ...
        <!--begining of the body content-->
            ...
            <div class="col-md-12" style =" background-color :#E5E5E5; text-align :center; border-radius:5px;">
             <div style ="background-color :#E5E5E5; color:orangered;">
                 <h1>Step 4 of 5 (KYC : Compnay File Uploads)</h1>
             </div>
            </div> 
            <div class="col-md-12" style ="height :40px;"></div> <!--Space of 20px-->
        <div class="row" style ="padding:10px; min-height :580px;">
		 <div class="col-md-4">
		                               <div class="form-group">BOARD RESOLUTION FOR ACCOUNT OPENNING:
                                            <asp:Image ID="impBoard" runat="server" Height="230px" Width="250px"  CssClass="img-responsive" />
                                            <asp:FileUpload ID="FileUpload1" runat="server" onchange="ShowPreview(this)" />
                                            <asp:LinkButton ID="butBoard" runat="server" CssClass="btn btn-default">Upload Now</asp:LinkButton>
                                         </div> 
			
             <div class="form-group">CERTIFICATE OF INCORPORATION:
                                            <asp:Image ID="imgCert" runat="server" Height="230px" Width="250px"  CssClass="img-responsive" />
                                            <asp:FileUpload ID="FileUpload4" runat="server" onchange="ShowPreview(this)" />
                                            <asp:LinkButton ID="butCert" runat="server" CssClass="btn btn-default">Upload Now</asp:LinkButton>
                                         </div> 
		 ...
		 <div class="col-md-4">
             ...
             <div class="form-group">FORM CO2:
                                            <asp:Image ID="imgCo2" runat="server" Height="230px" Width="250px"  CssClass="img-responsive" />
                                            <asp:FileUpload ID="FileUpload3" runat="server" onchange="ShowPreview(this)" />
                                            <asp:LinkButton ID="butCo2" runat="server" CssClass="btn btn-default">Upload Now</asp:LinkButton>
                                         </div> 
             
             <div class="form-group">FORM CO7:
                                            <asp:Image ID="imgCo7" runat="server" Height="230px" Width="250px"  CssClass="img-responsive" />
                                            <asp:FileUpload ID="FileUpload2" runat="server" onchange="ShowPreview(this)" />
                                            <asp:LinkButton ID="butCo7" runat="server" CssClass="btn btn-default">Upload Now</asp:LinkButton>
                                         </div> 
