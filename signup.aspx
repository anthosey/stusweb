    ...
    <div class="container" style ="background-color :#f1f1f1; border-radius :20px;">
        <!--begining of the body content-->
            ...
            <div class="col-md-12" style =" background-color :#E5E5E5; text-align :center; border-radius:5px;">
             <div class="jumbotron" style ="background-color :#E5E5E5; color:orangered;"><h1>Account Openning</h1>
                 <p style ="color:#000;">Please fill the form below to begin your account openning process</p>
                 <a href="login.aspx">If you have filled this form before, click here to continue the process.</a>
             </div>
            </div> 
            <div class="col-md-12" style ="height :40px;"></div> <!--Space of 20px-->
        <div class="row" style ="padding:10px; height :580px;">
		 <div class="col-md-4">
			<div class="form-group">
					<label>First Name:</label>
					<asp:TextBox ID="txtFname" placeholder ="Enter your first name" CssClass="form-control" runat="server"></asp:TextBox>

                	<label>Surname:</label>
					<asp:TextBox ID="txtSurname" placeholder ="Enter your surname" CssClass="form-control" runat="server"></asp:TextBox>

                    <label>Mobile:</label>
					<asp:TextBox ID="txtMobile" placeholder ="Enter your mobile number" CssClass="form-control" runat="server"></asp:TextBox>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
                  ...
                  <!--<a href="" class="btn btn-success width">Login</a> -->
                    <asp:LinkButton ID="butCreate" runat="server" CssClass="btn btn-warning btn-lg">Create New Account</asp:LinkButton>
