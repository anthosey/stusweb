<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Country_select.aspx.vb" Inherits="Country_Select" %>
...
<head>
    ...
    <script type ="text/javascript" >
        ...
        $(document).ready(function () {
            //    $('#country').append('<option>' + 'Oluseeye' + '</option>');
            // Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(valiate);
            ...
            $('#submit').click(function () {
                ...
                if ((country === 'Select Country') || (state === 'Select State')) {
                    alert('Please select a Country and State before you continue.');
                    return;
                }
                else {            //    alert('Country: ' + country + ', State: ' + state);
                    window.open("pers_stage1.aspx?country=" + country + "&state=" + state, "_self");
                }
    ...
    <div class="container" style ="background-color :#f1f1f1; min-height :400px;">
        <!--begining of the body content-->
            ...
            <div class="col-md-12" style =" background-color :#E5E5E5; text-align :center; border-radius:5px;">
             <div style ="background-color :#E5E5E5; color:orangered;"><h1>Select Country &amp; State of Origin</h1>
                 
             </div>
            </div> 
            <div class="col-md-12" style ="height :40px;"></div> <!--Space of 20px-->
        <div class="row">
		 <div class="col-md-8" style ="min-height :380px;">
            <img src="images/map.jpg" id="imgback" class =" img-rounded img-responsive" />
         </div>
			...
			<div class="form-group">
                    ...
                    <div class="form-group">STATE OF ORIGIN
                        ...
                        <br />
                    <a href="#" ID="submit" Class="btn btn-warning width">Continue</a>
				  </div>		
				  </div>
