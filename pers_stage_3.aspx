<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pers_stage_3.aspx.vb" Inherits="pers_stage_3" %>
        ...
        <marquee style="background-color :red;font-size :16px; color :#fff; padding :5px; font-weight :bold;">Please make sure you always provide us with accurate information in order to fast-track your account openning process. Thank you for choosing Standard Union Securities Limited as your portfolio manager.</marquee>
            ...
            <div class="col-md-12" style =" background-color :#E5E5E5; text-align :center; border-radius:5px;">
             <div style ="background-color :#E5E5E5; color:orangered;">
                 <h1>Step 5 of 5 (BANK ACCOUNT DETAILS)</h1>
             </div>
            </div> 
            <div class="col-md-12" style ="height :40px;"></div> <!--Space of 20px-->
...
<input class="form-control" type="text" runat ="server" id="txtBankName">	  
</div>
<div class="form-group">BANK BRANCH:
<input class="form-control" type="text" runat ="server" id="txtBranch">
</div>
<div class="form-group">BANK SORT CODE:
<input class="form-control" type="text" runat ="server"  id="txtSortCode">
</div>
</div>
				
		 <div class="col-md-4">
<div class="form-group">BANK ACCOUNT NAME:
<asp:Textbox class="form-control" runat ="server" id="txtAccountName"></asp:Textbox>
    
</div>
<div class="form-group">ACCOUNT NUMBER:
<asp:TextBox class="form-control" runat ="server"  id="txtAccountNo"></asp:TextBox>
</div>
<div class="form-group">DATE OF BANK ACCOUNT CREATION:
<asp:TextBox class="form-control" runat ="server" id="txtAccountDate"></asp:TextBox>
</div>
 <div class="form-group">BVN:
 <input class="form-control" maxlength ="11" type="text" runat ="server" id="txtBVN">
 </div>
            ...
            <div class ="col-md-4">
                ...
                <div class="jumbotron">
                    <h2><span runat ="server" id="spnTitle">Final Submission</span></h2>
                    <span runat ="server" id="spnMsg">If you are done with all required data, please click <strong>"Submit Finally"</strong> for final document submission so we can begin the process of account creation for you. Please note that, you will not be able to modify your details anymore, except there is need for adjustment, in which you shall be notified by your account officer.</span><br /><br />
                    <asp:LinkButton ID="butSubmit" runat="server" CssClass="btn btn-success btn-lg">Submit Finally</asp:LinkButton> 
                </div>
            </div>
               </div>
