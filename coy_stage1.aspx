<%@ Page Language="VB" AutoEventWireup="false" CodeFile="coy_stage1.aspx.vb" Inherits="coy_stage1" %>
        ...
        <!--begining of the body content-->
            ...
            <div class="col-md-12" style =" background-color :#E5E5E5; text-align :center; border-radius:5px;">
             <div style ="background-color :#E5E5E5; color:orangered;">
                 <h1>Step 2 of 5 (Corporate Information)</h1>
             </div>
            </div> 
            <div class="col-md-12" style ="height :40px;"></div> <!--Space of 20px-->
        <div class="row" style ="padding:10px; min-height :580px;">
		 <div class="col-md-4">
			<div class="form-group">COMPANY NAME:
                                 <input class="form-control" type="text" id ="txtCoyName" runat="server">
                                </div>
  
                                <div class="form-group">COMPANY ADDRESS:
                                    <input class="form-control" type="text" id="txtCoyAddy" runat="server">
                                </div>

                                <div class="form-group">REGISTRATION NO:
                                    <input class="form-control" type="text" id="txtRC" placeholder ="RC..." runat="server">
                                </div>
						        
				</div>
				
				<div class="col-md-4">
                                <div class="form-group">CORPORATE EMAIL:
                                     <input class="form-control" type="text" id="Text1" runat="server" >
                                </div>
                                <div class="form-group">OFFICE PHONE:
                                     <input class="form-control" type="text" id="Text2" runat="server" >
                                </div>
                                
                                <div class="form-group">REGISTRATION DATE (DD/MM/YY):
                                     <input class="form-control" type="text" id="txtRegDate" runat="server" >
                                </div>
